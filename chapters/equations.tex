...
Remember to read the task closely, and see whether it asks for the given resources to be $fully utilized$. If not, then introduce slack variables in your constraints.
